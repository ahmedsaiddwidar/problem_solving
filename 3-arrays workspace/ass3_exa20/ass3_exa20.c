...
int *DESCENDING_ORDER_EXCLUSIVE(int upper_value, int lower_value, int *resultant_array_size)
{
	int i;
	...
	{
		for(i = upper_value - 1; i > lower_value; i--)
		{
...
int main()
{
	...
	ptr = DESCENDING_ORDER_EXCLUSIVE(num1,num2,&arr_size_used);
